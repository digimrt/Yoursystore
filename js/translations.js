// Translations for Yoursy Store - Arabic (default), French, English
...
const translations = {
    ar: {
        ...
        checkout_delivery: "توصيل للمنزل",
        checkout_address: "العنوان",
        checkout_address_placeholder: "أدخل عنوان التوصيل...",
        ...
        payment_notice: "ملاحظة: الدفع قبل الاستلام",
        address_label: "العنوان",
        total_label: "المجموع",
        browse_variants: "تصفح الأنواع",
        buy_now: "اشتري الآن",
        coming_soon: "سيتوفر قريباً",
    },
    fr: {
        // Navigation
        nav_home: "Accueil",
        ...
        checkout_delivery: "Livraison à domicile",
        checkout_address: "Adresse",
        checkout_address_placeholder: "Entrez l'adresse de livraison...",
        ...
        snd_msg: "Envoyez-nous un Message",
    ...
    en: {
        ...
        checkout_address_placeholder: "Enter delivery address...",
        ...
        payment_notice: "Note: Payment before delivery",
        address_label: "Address",
        total_label: "Total",
        browse_variants: "Browse variants",
        buy_now: "Buy now",
...
function getCurrentLanguage() {
    return localStorage.getItem('mauri-lang') || 'ar';
}

function setLanguage(lang) {
    localStorage.setItem('mauri-lang', lang);
